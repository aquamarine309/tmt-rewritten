...
import { LayerData, LayerLayout, LayerConnections, SidebarLayers } from "./layers";
import { registerLayer } from "@framework/core/layer";
import { registerCustomComponents } from "@framework/core/ui";
import { StoryManager } from "@framework/core/story-manager";
import { stories } from "./core/database/stories";
...
StoryManager.registerTriggers(stories);